...
public class Student extends Human implements CSVConverter {
    ...
    public boolean equals(Object o) {
        ...
        return recordВookNumber == student.recordВookNumber && Objects.equals(groupNumber, student.groupNumber);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), recordВookNumber, groupNumber);
    }
